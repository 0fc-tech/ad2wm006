...
//Implémentation de Article DAO pour des articles stockés en mémoire (stockage en dur)
// du téléphone
//Pas d'articles réellement stockés ici. Juste une source d'articles en dur dans le code.
